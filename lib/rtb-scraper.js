 ...
 */
export async function* scrapeAllDisputes(onProgress) {
    console.log('[RTBScraper] Starting full scrape...');
    ...
    console.log(`[RTBScraper] Found ${totalResults} total results across ${totalPages} pages`);

    if (onProgress) {
        onProgress({ totalPages, totalResults, currentPage: 0 });
    }
    ...
    // Step 3: Fetch remaining pages with rate limiting and retry
    ...
    console.log('[RTBScraper] Scrape complete');
}
